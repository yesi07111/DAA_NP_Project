...
\textbf{T (Topología/Orden de Cómputo):} El cálculo se realiza en Post-orden (Bottom-up). Se procesan primero las hojas y se asciende hacia la raíz, garantizando que cuando calculemos un nodo, los valores de sus hijos ya estén disponibles.
